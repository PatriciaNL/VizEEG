...
NumSamps = size(c3_prem1_d1{1},2); % jic or else rmv
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:nSubs
    ...
    e = errorbar(c3_prem1_d1{i}, c3_pres1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C3 Pre');
    e.Color = '#13187D';
    hold on;
    % Plot post data
    e = errorbar(c3_postm1_d1{i}, c3_posts1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C3 Post');
    e.Color = '#4553F4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); %shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ylim([yMinLim1,yMaxLim1]);
    titletxt = [FileN1(4:11),' ', FileN1(13:20),' ',FileN1(22:24)];
    %titletxt = FileN1(4:24);%plt_info{i}(5:47);
    title(titletxt,'FontSize',15)
    box off;
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c4
    subplot(4,4,2)
    e = errorbar(c4_prem1_d1{i}, c4_pres1_d1{i},'LineWidth', 2, 'DisplayName', 'C4 Pre');
    e.Color = '#0F620C';
    hold on;
    % Plot post data
    e = errorbar(c4_postm1_d1{i}, c4_posts1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C4 Post');
    e.Color = '#30EA29';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); %shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    subplot(4,4,3)
    e = errorbar(c5_prem1_d1{i}, c5_pres1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C5 Pre');
    e.Color = '#4F1183';
    hold on;
    % Plot post data
    e = errorbar(c5_postm1_d1{i}, c5_posts1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C5 Post');
    e.Color = '#A152E4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    subplot(4,4,4)
    e = errorbar(c6_prem1_d1{i}, c6_pres1_d1{i}, 'LineWidth', 2, 'DisplayName', 'C6 Pre');
    e.Color = '#750E21';
    hold on;
    % Plot post data
    e = errorbar(c6_postm1_d1{i}, c6_posts1_d1{i},'LineWidth', 2, 'DisplayName', 'C6 Post');
    e.Color = '#E8506C';
    ...
    %subplot(1,4,2)
    subplot(4,4,5)
    e = errorbar(c3_prem1_d2{i}, c3_pres1_d2{i},'LineWidth', 2, 'DisplayName', 'C3 Pre');
    e.Color = '#13187D';
    hold on;
    % Plot post data
    e = errorbar(c3_postm1_d2{i}, c3_posts1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C3 Post');
    e.Color = '#4553F4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    titletxt = [FileN2(4:11),' ', FileN2(13:20),' ',FileN2(22:24)];
    title(titletxt,'FontSize',15)
    box off;
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c4
    subplot(4,4,6)
    e = errorbar(c4_prem1_d2{i}, c4_pres1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C4 Pre');
    e.Color = '#0F620C';
    hold on;
    % Plot post data
    e = errorbar(c4_postm1_d2{i}, c4_posts1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C4 Post');
    e.Color = '#30EA29';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c5
    subplot(4,4,7)
    e = errorbar(c5_prem1_d2{i}, c5_pres1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C5 Pre');
    e.Color = '#4F1183';
    hold on;
    % Plot post data
    e = errorbar(c5_postm1_d2{i}, c5_posts1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C5 Post');
    e.Color = '#A152E4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c6
    subplot(4,4,8)
    e = errorbar(c6_prem1_d2{i}, c6_pres1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C6 Pre');
    e.Color = '#750E21';
    hold on;
    % Plot post data
    e = errorbar(c6_postm1_d2{i}, c6_posts1_d2{i}, 'LineWidth', 2, 'DisplayName', 'C6 Post');
    e.Color = '#E8506C';
    % set params for plotting nicely
    %legend('Location','northwest','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    ...
    %subplot(1,4,3)
    subplot(4,4,9)
    e = errorbar(c3_prem1_d3{i}, c3_pres1_d3{i}, 'LineWidth', 2, 'DisplayName', 'C3 Pre');
    e.Color = '#13187D';
    hold on;
    % Plot post data
    e = errorbar(c3_postm1_d3{i}, c3_posts1_d3{i}, 'LineWidth', 2, 'DisplayName', 'C3 Post');
    e.Color = '#4553F4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    titletxt = [FileN3(4:11),' ', FileN3(13:21),' ',FileN3(23:25)];
    title(titletxt,'FontSize',15)
    box off;
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c4
    subplot(4,4,10)
    e = errorbar(c4_prem1_d3{i}, c4_pres1_d3{i}, 'LineWidth', 2, 'DisplayName', 'C4 Pre');
    e.Color = '#0F620C';
    hold on;
    % Plot post data
    e = errorbar(c4_postm1_d3{i}, c4_posts1_d3{i},'LineWidth', 2, 'DisplayName', 'C4 Post');
    e.Color = '#30EA29';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c5
    subplot(4,4,11)
    e = errorbar(c5_prem1_d3{i}, c5_pres1_d3{i},'LineWidth', 2, 'DisplayName', 'C5 Pre');
    e.Color = '#4F1183';
    hold on;
    % Plot post data
    e = errorbar(c5_postm1_d3{i}, c5_posts1_d3{i},'LineWidth', 2, 'DisplayName', 'C5 Post');
    e.Color = '#A152E4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c6
    subplot(4,4,12)
    e = errorbar(c6_prem1_d3{i}, c6_pres1_d3{i}, 'LineWidth', 2, 'DisplayName', 'C6 Pre');
    e.Color = '#750E21';
    hold on;
    % Plot post data
    e = errorbar(c6_postm1_d3{i}, c6_posts1_d3{i},'LineWidth', 2, 'DisplayName', 'C6 Post');
    e.Color = '#E8506C';
    % set params for plotting nicely
    %legend('Location','northwest','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    ...
    %subplot(1,4,4)
    subplot(4,4,13)
    e = errorbar(c3_prem1_d4{i}, c3_pres1_d4{i},'LineWidth', 2, 'DisplayName', 'C3 Pre');
    e.Color = '#13187D';
    hold on;
    % Plot post data
    e = errorbar(c3_postm1_d4{i}, c3_posts1_d4{i}, 'LineWidth', 2, 'DisplayName', 'C3 Post');
    e.Color = '#4553F4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    titletxt = [FileN4(4:11),' ', FileN4(13:21),' ',FileN4(23:25)];
    title(titletxt, 'FontSize',15)
    box off;
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c4
    subplot(4,4,14)
    e = errorbar(c4_prem1_d4{i}, c4_pres1_d4{i}, 'LineWidth', 2, 'DisplayName', 'C4 Pre');
    e.Color = '#0F620C';
    hold on;
    % Plot post data
    e = errorbar(c4_postm1_d4{i}, c4_posts1_d4{i},'LineWidth', 2, 'DisplayName', 'C4 Post');
    e.Color = '#30EA29';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c5
    subplot(4,4,15)
    e = errorbar(c5_prem1_d4{i}, c5_pres1_d4{i},'LineWidth', 2, 'DisplayName', 'C5 Pre');
    e.Color = '#4F1183';
    hold on;
    % Plot post data
    e = errorbar(c5_postm1_d4{i}, c5_posts1_d4{i},'LineWidth', 2, 'DisplayName', 'C5 Post');
    e.Color = '#A152E4';
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;
    set(gcf,'color','w'); shg;
    xlabel('Frames'); ylabel('Amp (mV)');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% plot pre and post for c6
    subplot(4,4,16)
    e = errorbar(c6_prem1_d4{i}, c6_pres1_d4{i}, 'LineWidth', 2, 'DisplayName', 'C6 Pre');
    e.Color = '#750E21';
    hold on;
    % Plot post data
    e = errorbar(c6_postm1_d4{i}, c6_posts1_d4{i}, 'LineWidth', 2, 'DisplayName', 'C6 Post');
    e.Color = '#E8506C';
    ylim([yMinLim4,yMaxLim4]);
    % set params for plotting nicely
    %legend('Location','northeast','FontAngle','italic','FontSize',6);grid;

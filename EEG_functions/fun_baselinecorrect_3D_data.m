function databc = fun_baselinecorrect_3D_data(data, baselinesamps)
    ...
    [ntime, nchannels, ntrials] = size(data); % params for VVV
    databc = zeros(ntime, nchannels, ntrials); % empty data matrix 2 fill
